...
from models import ChatRequest, RewriteRequest, NextStepsRequest, AnalysisResult
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "https://my-frontend.onrender.com", "*"], # Allow specific origins + wildcard for dev
